...
public class webpageDriver {
	...
	public static void insertValueToWebsite() {
		...
		driver.findElement(By.xpath("//*[@id=\"homeloaninterest\"]")).sendKeys(Keys.BACK_SPACE+read.data[3]);
		...
		driver.findElement(By.xpath("//*[@id=\"homeloanterm\"]")).sendKeys(Keys.BACK_SPACE);
		driver.findElement(By.xpath("//*[@id=\"homeloanterm\"]")).sendKeys(read.data[4]);
		...
		driver.findElement(By.xpath("//*[@id=\"loanfees\"]")).sendKeys(read.data[5]);
		...
		driver.findElement(By.xpath("//*[contains(text(),"+read.data[6].split(" ")[0]+")]")).click();
		driver.findElement(By.xpath("//*[contains(text(),"+read.data[6].split(" ")[1]+")]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"maintenanceexpenses\"]")).sendKeys(read.data[10]);
